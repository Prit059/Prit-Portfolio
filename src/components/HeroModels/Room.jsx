...
export function Room(props) {
  ...
  const matcanMaterial = new THREE.MeshPhongMaterial({
    color: '#fff',
  })
  const matcanMaterial1 = new THREE.MeshPhongMaterial({
    color: 'gray',
  })
  const matcanMaterial2 = new THREE.MeshPhongMaterial({
    color: 'white',
  })
  const matcanMaterial3 = new THREE.MeshPhongMaterial({
    color: 'gray',
  })
  ...
  return (
    <group {...props} dispose={null}>
      ...
      <mesh geometry={nodes.body1_blinn1_0.geometry} material={matcanMaterial3} />
      <mesh geometry={nodes.cabin_blinn1_0.geometry} material={matcanMaterial1} />
      <mesh geometry={nodes.chair_body_blinn1_0.geometry} material={matcanMaterial} />
      ...
      <mesh geometry={nodes.handls_blinn1_0.geometry} material={matcanMaterial2} />
      ...
      <mesh geometry={nodes.lamp_white_blinn1_0.geometry} material={matcanMaterial} />
      ...
      <mesh geometry={nodes.radiator_blinn1_0.geometry} material={matcanMaterial2} />
      <mesh geometry={nodes.radiator_blinn1_0001.geometry} material={matcanMaterial2} />
      <mesh geometry={nodes.railing_blinn1_0.geometry} material={matcanMaterial2} />
      <mesh geometry={nodes.red_bttns_blinn1_0.geometry} material={matcanMaterial2} />
      <mesh geometry={nodes.red_vac_blinn1_0.geometry} material={matcanMaterial2} />
